...
const defaultProviders = {
  ...
  GOERLI: process.env.GOERLI_RPC || 'https://rpc.ankr.com/eth_goerli',
  MATIC: process.env.MATIC_RPC || 'https://polygon-rpc.com',
  MATICMUMBAI: process.env.MATICMUMBAI_RPC || 'https://rpc.ankr.com/polygon_mumbai',
  ARBITRUM: process.env.ARBITRUM_RPC || 'https://rpc.ankr.com/arbitrum',
  ARBITRUMNOVA: process.env.ARBITRUMNOVA_RPC || 'https://nova.arbitrum.io/rpc',
  ARBITRUMGOERLI: process.env.ARBITRUMGOERLI_RPC || 'https://goerli-rollup.arbitrum.io/rpc',
  AVALANCHE: process.env.AVALANCHE_RPC || 'https://api.avax.network/ext/bc/C/rpc',
  AVALANCHEFUJI: process.env.AVALANCHEFUJI_RPC || 'https://api.avax-test.network/ext/bc/C/rpc',
  BINANCE: process.env.BINANCE_RPC || 'https://bscrpc.com',
  BINANCETESTNET: process.env.BINANCETESTNET_RPC || 'https://data-seed-prebsc-1-s3.binance.org:8545',
  FANTOM: process.env.FANTOM_RPC || 'https://rpcapi.fantom.network',
  FANTOMTESTNET: process.env.FANTOMTESTNET_RPC || 'https://rpc.ankr.com/fantom_testnet/',
  MOONBEAM: process.env.MOONBEAM_RPC || 'https://rpc.api.moonbeam.network',
  MOONBEAMTESTNET: process.env.MOONBEAMTESTNET_RPC || 'https://rpc.api.moonbase.moonbeam.network',
  THUNDERCORE: process.env.THUNDERCORE_RPC || 'https://mainnet-rpc.thundercore.com',
  THUNDERCORETESTNET: process.env.THUNDERCORETESTNET_RPC || 'https://testnet-rpc.thundercore.com',
